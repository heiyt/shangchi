 ...
 */
int shangchi_axp2101::pmu_register_read(uint8_t devAddr, uint8_t regAddr, uint8_t *data, uint8_t len)
{
    if (len == 0) {
        return ESP_OK;
    }
 ...
 */
int shangchi_axp2101::pmu_register_write_byte(uint8_t devAddr, uint8_t regAddr, uint8_t *data, uint8_t len)
{
    if (data == nullptr) {
        return ESP_FAIL;
    }
 ...
 */
esp_err_t shangchi_axp2101::i2c_init_axp2101()
{
